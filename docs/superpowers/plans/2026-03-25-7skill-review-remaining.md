...
```bash
git add repository/ios/SoyokaModules/Sources/SharedUI/Components/WaveformView.swift
...
git add repository/ios/SoyokaModules/Sources/FeatureMemo/MemoList/MemoListView.swift
git add repository/ios/SoyokaModules/Tests/FeatureMemoTests/MemoListReducerTests.swift
...
```bash
git add repository/ios/SoyokaModules/Sources/FeatureMemo/MemoDetail/MemoDetailView.swift
...
```bash
git add repository/ios/SoyokaModules/Tests/
